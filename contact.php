...
.back-button:hover {
  ...
  <p>We would love to hear from you! Whether you have a question, feedback, or just want to chat, feel free to reach out. Our team is here to assist you in any way we can.</p>
</div>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <textarea name="message" id="message" cols="30" rows="5" class="form-control"
                  placeholder="Say hello to us" name="message"></textarea>
              </div>
            </div>
